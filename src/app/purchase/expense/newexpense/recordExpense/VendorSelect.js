...
const VendorSelect = ({ formik }) => {
  ...
  const apiCall = async () => {
    try {
      ...
      let params = {
        method: "GET",
        url: `api/v1/bills/get-vendors?org_id=${organization_id}`,
  ...
  const handleClearVendor = (e) => {
    ...
    formik.setFieldValue("vendor_Name", "");
  ...
  const handleVendorSelect = (vendor) => {
    ...
    formik.setFieldValue("vendor_Name", vendor.contact_name);
        ...
        >
          ...
          >
            {formik.values.vendor_Name ? (
              ...
              <Typography
                sx={{ color: "#66686b", fontSize: "13px" }}
              ></Typography>
            )}
          </Box>
          <KeyboardArrowDownIcon
            sx={{ color: "gray", fontSize: "22px", marginRight: "8px" }}
          />
