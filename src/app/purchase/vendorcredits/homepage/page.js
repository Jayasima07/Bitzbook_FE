...
import VendorCreditsWorkflow from "../../../../assets/vendor-credits-workflow.png";
      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 3 }}>
          ...
          <Typography sx={{ color: "#666", fontSize: "15px" }}>
            Create vendor credits and apply them to multiple bills when buying
