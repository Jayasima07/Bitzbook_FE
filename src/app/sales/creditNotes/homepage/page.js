...
import BUTTON_COLORS from "../../../common/btn/Button";
import CreditNote from "../../../../assets/creditnote.png";
...
const dummyDefaultFilters = [
  ...
  { id: 3, label: "Pending Approval", isFavorite: false },
  { id: 4, label: "Approved", isFavorite: false },
  { id: 5, label: "Sent", isFavorite: false },
  { id: 6, label: "Customer Viewed", isFavorite: false },
  { id: 7, label: "Accepted", isFavorite: false },
  { id: 8, label: "Invoiced", isFavorite: false },
  { id: 9, label: "Declined", isFavorite: false },
  { id: 10, label: "Expired", isFavorite: false },
];
