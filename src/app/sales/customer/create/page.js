...
const CustomerForm = () => {
  ...
  useEffect(() => {
    if (customerData && Object.keys(customerData).length > 0) {
      const { contact_id, _id, contact_persons = [], ...rest } = customerData;

      const sanitizedContactPersons = Array.isArray(contact_persons)
      ...
      formik.setValues({
        ...formik.values,
        ...rest,
        contact_id: "", // clear contact_id in main object
        contact_persons: sanitizedContactPersons,
        _id: undefined, // omit _id to prevent validation issues
      });
    }
    console.log(formik.values, "values clone");
  }, [customerData]);
                      ...
                      >
                        {["Mr.", "Mrs.", "Ms.", "Dr."].map((title) => (
                          <MenuItem
                            ...
                            value={title}
                            selected={
                              formik.values.contact_salutation === title
                            }
                            sx={{
                              fontSize: "13px",
                              borderRadius: "5px",
